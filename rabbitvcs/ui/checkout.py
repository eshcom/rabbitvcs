...
# esh: path=None -> paths=[None]
def checkout_factory(vcs, paths=[None], url=None, revision=None, quiet=False):
	if not vcs:
...
if __name__ == "__main__":
	...
	# esh: pass paths to checkout_factory
	window = checkout_factory(options.vcs, paths=paths, url=url, revision=options.revision, quiet=options.quiet)
